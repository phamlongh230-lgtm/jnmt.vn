...
const PRESETS = [
  { label: "Link trường", value: "https://jnmt.hs.jne.kr/jnmt_hs/main.do?sysId=jnmt_hs" },
...
export default function QRCodePage() {
  ...
  const [text, setText] = useState("https://jnmt.hs.jne.kr/jnmt_hs/main.do?sysId=jnmt_hs");
