...
const SCHEDULE_DATA: { dayKey: string; dayShort: string; classes: ClassItem[] }[] = [
  {
    ...
    classes: [
      ...
      { time: "10:50", s: "디지털 (KT số)",         r: "",    c: "#f97316" },
      { time: "11:50", s: "기계 (Kỹ thuật)",        r: "",    c: "#10b981" },
      { time: "13:40", s: "한국어 (Tiếng Hàn)",     r: "",    c: "#0ea5e9" },
      { time: "14:40", s: "영어 (Tiếng Anh)",       r: "",    c: "#8b5cf6" },
      { time: "15:40", s: "수학 (Toán)",             r: "",    c: "#2563eb" },
    ],
  },
  {
    dayKey: "tuesday", dayShort: "화",
    classes: [
      { time: "08:50", s: "한국어 (Tiếng Hàn)",     r: "",    c: "#0ea5e9" },
      { time: "09:50", s: "한국어 (Tiếng Hàn)",     r: "",    c: "#0ea5e9" },
      { time: "10:50", s: "한국어 (Tiếng Hàn)",     r: "",    c: "#0ea5e9" },
      { time: "11:50", s: "수학 (Toán)",             r: "",    c: "#2563eb" },
      { time: "13:40", s: "기계 (Kỹ thuật)",        r: "",    c: "#10b981" },
      { time: "14:40", s: "국어 (Ngữ văn)",         r: "",    c: "#0ea5e9" },
      { time: "15:40", s: "체육 (Thể dục)",         r: "Sân", c: "#ef4444" },
    ],
  },
  {
    dayKey: "wednesday", dayShort: "수",
    classes: [
      { time: "08:50", s: "체육 (Thể dục)",         r: "Sân", c: "#ef4444" },
      { time: "09:50", s: "디지털 (KT số)",         r: "",    c: "#f97316" },
      { time: "10:50", s: "한국어 (Tiếng Hàn)",     r: "",    c: "#0ea5e9" },
  ...
  },
  {
    ...
    classes: [
      ...
      { time: "11:50", s: "국어 (Ngữ văn)",         r: "",    c: "#0ea5e9" },
      { time: "13:40", s: "한국어 (Tiếng Hàn)",     r: "",    c: "#0ea5e9" },
    ],
  },
];
